...
--
-- Inventory: 61 tables (alphabetical below), covering every `CREATE TABLE` in
-- `supabase/migrations` for this app. When you add a migration that creates a new
-- `public` table, add its name to the TRUNCATE list and to the drift-check array.
--
...
--       'booking_restriction_exceptions','booking_restrictions','booking_table_assignments',
--       'booking_ticket_lines','bookings','calendar_blocks','calendar_service_assignments',
--       'class_instances','class_timetable','class_types','combination_auto_overrides',
--       'communication_logs','communication_settings','communications','custom_client_fields',
--       'event_sessions','event_ticket_types','events','experience_events',
--       'floor_plan_table_positions','floor_plans','guests','import_booking_references',
--       'import_booking_rows','import_column_mappings','import_files','import_records',
--       'import_sessions','import_validation_issues','party_size_durations',
...
--       'support_audit_events','support_sessions','table_blocks','table_combination_members',
--       'table_combinations','table_statuses','unified_calendars','user_devices','user_profiles',
