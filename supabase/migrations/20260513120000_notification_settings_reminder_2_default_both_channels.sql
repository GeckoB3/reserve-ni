-- Align DB default with app: day-of reminder (reminder_2) offers email + SMS like reminder_1;
-- new venues get both channels in the template default (opt-in still via reminder_2_enabled).
