...
COMMENT ON COLUMN venues.light_plan_converted_at IS 'Appointments Light: when paid £10/month period started after free window. NULL if still in free period or not Light.';
